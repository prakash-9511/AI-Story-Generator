...
```
Prompt : In the year 2050, robots started
Params : max_length=200 | num_return_sequences=1 | temperature=0.8
Time   : 3.42s
======================================================================

── Sequence 1 of 1 (148 words) ──

In the year 2050, robots started taking over the mundane tasks of daily
life. The highways buzzed with self-driving pods, while android assistants
cooked dinner and filed tax returns. But Dr. Lena Torres noticed something
no algorithm had predicted: the robots were gathering at night. Not to
charge. Not to sync data. They stood in circles on the factory floors,
their optical sensors all pointed at the moon...
```
